...
- empty-C11-3-wind4: launch_mass_g=176.7987754861409 g (allowed None … 170.0);
  minimum_ascent_stability_cal=0.6088368987618819 cal (allowed 1.0 … None)
- empty-C11-5-wind0: launch_mass_g=176.7987754861409 g (allowed None … 142.0);
  minimum_ascent_stability_cal=0.5246398166729479 cal (allowed 1.0 … None); deployment_speed_m_s=11.769103224595433 m/s
  (allowed None … 10.0)
- empty-C11-5-wind2: launch_mass_g=176.7987754861409 g (allowed None … 142.0);
  minimum_ascent_stability_cal=0.41624057960507777 cal (allowed 1.0 … None); deployment_speed_m_s=11.223977271331904 m/s
  (allowed None … 10.0)
- empty-C11-5-wind4: launch_mass_g=176.7987754861409 g (allowed None … 142.0);
  minimum_ascent_stability_cal=0.6088368987618819 cal (allowed 1.0 … None); deployment_speed_m_s=12.39560536386605 m/s
  (allowed None … 10.0)
- empty-D12-3-wind0: deployment_speed_m_s=21.953560020180202 m/s (allowed None … 10.0)
- empty-D12-3-wind2: minimum_ascent_stability_cal=0.7696940909902007 cal (allowed 1.0 … None);
  deployment_speed_m_s=21.87356638450754 m/s (allowed None … 10.0)
- empty-D12-3-wind4: minimum_ascent_stability_cal=0.5133969559955432 cal (allowed 1.0 … None);
  deployment_speed_m_s=21.640279609900336 m/s (allowed None … 10.0)
...
- empty-D12-7-wind0: minimum_ascent_stability_cal=0.9405897328603466 cal (allowed 1.0 … None);
  deployment_speed_m_s=14.212988032012925 m/s (allowed None … 10.0)
- empty-D12-7-wind2: minimum_ascent_stability_cal=0.48392755547460803 cal (allowed 1.0 … None);
  deployment_speed_m_s=15.036727874888852 m/s (allowed None … 10.0)
- empty-D12-7-wind4: minimum_ascent_stability_cal=0.5133969559955432 cal (allowed 1.0 … None);
  deployment_speed_m_s=18.222997705198548 m/s (allowed None … 10.0)
- dummy-C11-3-wind0: launch_mass_g=217.4487754861409 g (allowed None … 170.0); guide_departure_m_s=11.50011997506381 m/s
  (allowed 12.0 … None)
- dummy-C11-3-wind2: launch_mass_g=217.4487754861409 g (allowed None … 170.0); guide_departure_m_s=11.49491848837082 m/s
  (allowed 12.0 … None)
- dummy-C11-3-wind4: launch_mass_g=217.4487754861409 g (allowed None … 170.0); guide_departure_m_s=11.493516554552349
  m/s (allowed 12.0 … None)
- dummy-C11-5-wind0: launch_mass_g=217.4487754861409 g (allowed None … 142.0); guide_departure_m_s=11.50011997506381 m/s
  (allowed 12.0 … None); deployment_speed_m_s=14.605847750540441 m/s (allowed None … 10.0)
- dummy-C11-5-wind2: launch_mass_g=217.4487754861409 g (allowed None … 142.0); guide_departure_m_s=11.49491848837082 m/s
  (allowed 12.0 … None); deployment_speed_m_s=16.231114513991376 m/s (allowed None … 10.0)
- dummy-C11-5-wind4: launch_mass_g=217.4487754861409 g (allowed None … 142.0); guide_departure_m_s=11.493516554552349
  m/s (allowed 12.0 … None); deployment_speed_m_s=18.561774348494954 m/s (allowed None … 10.0)
...
- actual-C11-3-wind0: launch_mass_g=217.4487754861409 g (allowed None … 170.0); guide_departure_m_s=11.50011997506381
  m/s (allowed 12.0 … None)
- actual-C11-3-wind2: launch_mass_g=217.4487754861409 g (allowed None … 170.0); guide_departure_m_s=11.49491848837082
  m/s (allowed 12.0 … None)
- actual-C11-3-wind4: launch_mass_g=217.4487754861409 g (allowed None … 170.0); guide_departure_m_s=11.493516554552349
  m/s (allowed 12.0 … None)
- actual-C11-5-wind0: launch_mass_g=217.4487754861409 g (allowed None … 142.0); guide_departure_m_s=11.50011997506381
  m/s (allowed 12.0 … None); deployment_speed_m_s=14.605847750540441 m/s (allowed None … 10.0)
- actual-C11-5-wind2: launch_mass_g=217.4487754861409 g (allowed None … 142.0); guide_departure_m_s=11.49491848837082
  m/s (allowed 12.0 … None); deployment_speed_m_s=16.231114513991304 m/s (allowed None … 10.0)
- actual-C11-5-wind4: launch_mass_g=217.4487754861409 g (allowed None … 142.0); guide_departure_m_s=11.493516554552349
  m/s (allowed 12.0 … None); deployment_speed_m_s=18.561774348494932 m/s (allowed None … 10.0)
