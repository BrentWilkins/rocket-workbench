...
- empty-C11-3-wind4: launch_mass_g=176.7987754861409 g (allowed None … 170.0); minimum_ascent_stability_cal=0.6088368987618832 cal (allowed 1.0 … None)
...
- empty-C11-5-wind2: launch_mass_g=176.7987754861409 g (allowed None … 142.0); minimum_ascent_stability_cal=0.416240579604943 cal (allowed 1.0 … None); deployment_speed_m_s=11.223977271334377 m/s (allowed None … 10.0)
- empty-C11-5-wind4: launch_mass_g=176.7987754861409 g (allowed None … 142.0); minimum_ascent_stability_cal=0.6088368987618832 cal (allowed 1.0 … None); deployment_speed_m_s=12.395605363866029 m/s (allowed None … 10.0)
- empty-D12-3-wind0: deployment_speed_m_s=21.953560020180202 m/s (allowed None … 10.0)
- empty-D12-3-wind2: minimum_ascent_stability_cal=0.7696940909901994 cal (allowed 1.0 … None); deployment_speed_m_s=21.873566384507868 m/s (allowed None … 10.0)
- empty-D12-3-wind4: minimum_ascent_stability_cal=0.5133969559955419 cal (allowed 1.0 … None); deployment_speed_m_s=21.64027960989945 m/s (allowed None … 10.0)
...
- empty-D12-7-wind0: minimum_ascent_stability_cal=0.9405897328603453 cal (allowed 1.0 … None); deployment_speed_m_s=14.212988032012923 m/s (allowed None … 10.0)
- empty-D12-7-wind2: minimum_ascent_stability_cal=0.48392755547459465 cal (allowed 1.0 … None); deployment_speed_m_s=15.036727874890811 m/s (allowed None … 10.0)
- empty-D12-7-wind4: minimum_ascent_stability_cal=0.5133969559955419 cal (allowed 1.0 … None); deployment_speed_m_s=18.222997705191403 m/s (allowed None … 10.0)
- dummy-C11-3-wind0: launch_mass_g=205.99877548614091 g (allowed None … 170.0); guide_departure_m_s=11.851016279918268 m/s (allowed 12.0 … None)
- dummy-C11-3-wind2: launch_mass_g=205.99877548614091 g (allowed None … 170.0); guide_departure_m_s=11.845441181702606 m/s (allowed 12.0 … None)
- dummy-C11-3-wind4: launch_mass_g=205.99877548614091 g (allowed None … 170.0); guide_departure_m_s=11.843736758342146 m/s (allowed 12.0 … None)
- dummy-C11-5-wind0: launch_mass_g=205.99877548614091 g (allowed None … 142.0); guide_departure_m_s=11.851016279918268 m/s (allowed 12.0 … None); deployment_speed_m_s=12.99409864656935 m/s (allowed None … 10.0)
- dummy-C11-5-wind2: launch_mass_g=205.99877548614091 g (allowed None … 142.0); guide_departure_m_s=11.845441181702606 m/s (allowed 12.0 … None); deployment_speed_m_s=14.443933282600847 m/s (allowed None … 10.0)
- dummy-C11-5-wind4: launch_mass_g=205.99877548614091 g (allowed None … 142.0); guide_departure_m_s=11.843736758342146 m/s (allowed 12.0 … None); deployment_speed_m_s=16.98876689020952 m/s (allowed None … 10.0)
...
- actual-C11-3-wind0: launch_mass_g=205.99877548614091 g (allowed None … 170.0); guide_departure_m_s=11.851016279918268 m/s (allowed 12.0 … None)
- actual-C11-3-wind2: launch_mass_g=205.99877548614091 g (allowed None … 170.0); guide_departure_m_s=11.845441181702606 m/s (allowed 12.0 … None)
- actual-C11-3-wind4: launch_mass_g=205.99877548614091 g (allowed None … 170.0); guide_departure_m_s=11.843736758342146 m/s (allowed 12.0 … None)
- actual-C11-5-wind0: launch_mass_g=205.99877548614091 g (allowed None … 142.0); guide_departure_m_s=11.851016279918268 m/s (allowed 12.0 … None); deployment_speed_m_s=12.99409864656935 m/s (allowed None … 10.0)
- actual-C11-5-wind2: launch_mass_g=205.99877548614091 g (allowed None … 142.0); guide_departure_m_s=11.845441181702606 m/s (allowed 12.0 … None); deployment_speed_m_s=14.443933282600847 m/s (allowed None … 10.0)
- actual-C11-5-wind4: launch_mass_g=205.99877548614091 g (allowed None … 142.0); guide_departure_m_s=11.843736758342146 m/s (allowed 12.0 … None); deployment_speed_m_s=16.98876689020952 m/s (allowed None … 10.0)
