...
Run: `bt60-24-e-upper-avionics`

Provisional software demonstration. Physical assembly and flight validation are pending.

Configuration SHA256: `43c59770a0588490e161a2b37e8816479f336a989945b2054b074c3a1146d9cf`
...
| dummy-E12-4-wind0 | completed / outside configured limits | 317.66 | 13.24 | 1.64 | 19.39 | 5.43 | 0.13 | 13.99 | 14.98 | 85.03 |
| dummy-E12-4-wind2 | completed / outside configured limits | 315.22 | 13.24 | 1.22 | 19.43 | 5.43 | 84.20 | 13.98 | 14.98 | 84.89 |
| dummy-E12-4-wind4 | completed / outside configured limits | 308.61 | 13.24 | 0.96 | 19.54 | 5.43 | 166.78 | 13.97 | 14.97 | 84.51 |
| dummy-E12-6-wind0 | completed / incomplete inputs | 332.21 | 13.24 | 1.43 | 0.81 | 5.43 | 0.20 | 13.99 | 14.98 | 85.03 |
| dummy-E12-6-wind2 | completed / incomplete inputs | 329.30 | 13.24 | 1.22 | 3.62 | 5.43 | 80.14 | 13.98 | 14.98 | 84.89 |
| dummy-E12-6-wind4 | completed / outside configured limits | 321.22 | 13.24 | 0.96 | 7.12 | 5.43 | 158.99 | 13.97 | 14.97 | 84.51 |
| dummy-E12-8-wind0 | completed / outside configured limits | 332.21 | 13.24 | 1.43 | 15.27 | 5.43 | 0.13 | 13.99 | 14.98 | 85.03 |
| dummy-E12-8-wind2 | completed / outside configured limits | 329.30 | 13.24 | 1.22 | 19.48 | 5.43 | 66.72 | 13.98 | 14.98 | 84.89 |
| dummy-E12-8-wind4 | completed / outside configured limits | 321.22 | 13.24 | 0.96 | 21.57 | 5.43 | 128.51 | 13.97 | 14.97 | 84.51 |
| actual-E12-4-wind0 | completed / outside configured limits | 317.66 | 13.24 | 1.64 | 19.39 | 5.43 | 0.13 | 13.99 | 14.98 | 85.03 |
| actual-E12-4-wind2 | completed / outside configured limits | 315.22 | 13.24 | 1.22 | 19.43 | 5.43 | 84.20 | 13.98 | 14.98 | 84.89 |
| actual-E12-4-wind4 | completed / outside configured limits | 308.61 | 13.24 | 0.96 | 19.54 | 5.43 | 166.78 | 13.97 | 14.97 | 84.51 |
| actual-E12-6-wind0 | completed / incomplete inputs | 332.21 | 13.24 | 1.43 | 0.81 | 5.43 | 0.20 | 13.99 | 14.98 | 85.03 |
| actual-E12-6-wind2 | completed / incomplete inputs | 329.30 | 13.24 | 1.22 | 3.62 | 5.43 | 80.14 | 13.98 | 14.98 | 84.89 |
| actual-E12-6-wind4 | completed / outside configured limits | 321.22 | 13.24 | 0.96 | 7.12 | 5.43 | 158.99 | 13.97 | 14.97 | 84.51 |
| actual-E12-8-wind0 | completed / outside configured limits | 332.21 | 13.24 | 1.43 | 15.27 | 5.43 | 0.13 | 13.99 | 14.98 | 85.03 |
| actual-E12-8-wind2 | completed / outside configured limits | 329.30 | 13.24 | 1.22 | 19.48 | 5.43 | 66.72 | 13.98 | 14.98 | 84.89 |
| actual-E12-8-wind4 | completed / outside configured limits | 321.22 | 13.24 | 0.96 | 21.57 | 5.43 | 128.51 | 13.97 | 14.97 | 84.51 |
...
- dummy-E12-8-wind4: Recovery device deployment at high speed (21.6 m/s):  "Nominal 457 mm parachute and lines"
...
- actual-E12-8-wind4: Recovery device deployment at high speed (21.6 m/s):  "Nominal 457 mm parachute and lines"
...
- empty-E12-4-wind0: minimum_ascent_stability_cal=0.9956563496375204 cal (allowed 1.0 … None); deployment_speed_m_s=20.097417337006586 m/s (allowed None … 10.0)
- empty-E12-4-wind2: minimum_ascent_stability_cal=0.59674891700617 cal (allowed 1.0 … None); deployment_speed_m_s=20.0441887612395 m/s (allowed None … 10.0)
- empty-E12-4-wind4: minimum_ascent_stability_cal=0.34134750273764225 cal (allowed 1.0 … None); deployment_speed_m_s=19.862886799410308 m/s (allowed None … 10.0)
- empty-E12-6-wind0: minimum_ascent_stability_cal=0.48480712183905783 cal (allowed 1.0 … None)
- empty-E12-6-wind2: minimum_ascent_stability_cal=0.5104232946310258 cal (allowed 1.0 … None)
- empty-E12-6-wind4: minimum_ascent_stability_cal=0.34134750273764225 cal (allowed 1.0 … None)
- empty-E12-8-wind0: minimum_ascent_stability_cal=0.48480712183905783 cal (allowed 1.0 … None); deployment_speed_m_s=15.389153774528143 m/s (allowed None … 10.0)
- empty-E12-8-wind2: minimum_ascent_stability_cal=0.5104232946311191 cal (allowed 1.0 … None); deployment_speed_m_s=16.05309563816159 m/s (allowed None … 10.0)
- empty-E12-8-wind4: minimum_ascent_stability_cal=0.34134750273764225 cal (allowed 1.0 … None); deployment_speed_m_s=19.835320216684796 m/s (allowed None … 10.0)
- dummy-E12-4-wind0: deployment_speed_m_s=19.38504981458053 m/s (allowed None … 10.0)
- dummy-E12-4-wind2: deployment_speed_m_s=19.43081492457062 m/s (allowed None … 10.0)
- dummy-E12-4-wind4: minimum_ascent_stability_cal=0.9641341026945015 cal (allowed 1.0 … None); deployment_speed_m_s=19.538577908068323 m/s (allowed None … 10.0)
...
- dummy-E12-6-wind4: minimum_ascent_stability_cal=0.9641341026945015 cal (allowed 1.0 … None)
- dummy-E12-8-wind0: deployment_speed_m_s=15.265515558745012 m/s (allowed None … 10.0)
- dummy-E12-8-wind2: deployment_speed_m_s=19.47526725483278 m/s (allowed None … 10.0)
- dummy-E12-8-wind4: minimum_ascent_stability_cal=0.9641341026945015 cal (allowed 1.0 … None); deployment_speed_m_s=21.572609353308806 m/s (allowed None … 10.0)
- actual-E12-4-wind0: deployment_speed_m_s=19.38504981458053 m/s (allowed None … 10.0)
- actual-E12-4-wind2: deployment_speed_m_s=19.430814924569574 m/s (allowed None … 10.0)
- actual-E12-4-wind4: minimum_ascent_stability_cal=0.9641341026945002 cal (allowed 1.0 … None); deployment_speed_m_s=19.538577908068365 m/s (allowed None … 10.0)
...
- actual-E12-6-wind4: minimum_ascent_stability_cal=0.9641341026945002 cal (allowed 1.0 … None)
- actual-E12-8-wind0: deployment_speed_m_s=15.265515558744992 m/s (allowed None … 10.0)
- actual-E12-8-wind2: deployment_speed_m_s=19.47526725482674 m/s (allowed None … 10.0)
- actual-E12-8-wind4: minimum_ascent_stability_cal=0.9641341026945002 cal (allowed 1.0 … None); deployment_speed_m_s=21.572609353308657 m/s (allowed None … 10.0)
