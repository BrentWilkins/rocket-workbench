"""Continue an exact-production SSTm case that failed only the residual gate."""
...
METHOD = "same-grid SSTm exact-production residual convergence continuation"
...
def main() -> None:
    ...
    result = restart(
        ...
        allow_source_residual_only_failure=True,
    )
